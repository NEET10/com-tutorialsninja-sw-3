...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully() {
        ...
        selectByValueFromDropDown(By.xpath("//select[@id='input-sort']"), "https://tutorialsninja.com/demo/index.php?route=product/category&path=18&sort=p.price&order=ASC");
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        selectByValueFromDropDown(By.xpath("//select[@id='input-sort']"), "https://tutorialsninja.com/demo/index.php?route=product/category&path=18&sort=p.price&order=DESC");

        //2.4 Select Product “MacBook”
        clickOnElement(By.linkText("MacBook"));
        // Thread.sleep(2000);
        //2.5 Verify the text “MacBook”
        verifyExpectedAndActual(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[2]/h1[1]"), "MacBook");
        ...
        verifyExpectedAndActual(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/h1[1]"), "Shopping Cart  (0.00kg)");
        //2.10 Verify the Product name "MacBook"
        verifyExpectedAndActual(By.linkText("MacBook"), "MacBook");
        ...
        verifyExpectedAndActual(By.xpath("//body[1]/div[2]/div[2]/div[1]/div[2]/div[1]/table[1]/tbody[1]/tr[4]/td[2]"), "$1,204.00");
        ...
        //Firstname
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "James");
        //Last name
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Bond");
        //Email
        sendTextToElement(By.id("input-payment-email"), "James@gmail.com");
        //Telephone
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "01254 735992");
        //Address 1
        sendTextToElement(By.cssSelector("#input-payment-address-1"), "Akshardham");
        //City
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "Gandhinagar");
        //Post code
        sendTextToElement(By.id("input-payment-postcode"), "382350");
        //Country
        ...
        sendTextToElement(By.tagName("textarea"), "Thanks");
